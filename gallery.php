    ...
    <div class="container">
        <div class="grid">
            ...
            <div class="row">
                <div class="col-md-3">
                    <br>
                    <img src="d5.jpg" alt="" class="img-fluid img-thumbnail"> 
                </div>

                <div class="col-md-4">
                    <br>

                    <img src="d15.jpg" alt="" class="img-fluid img-thumbnail"> 
                </div>

                <div class="col-md-4">
                    <br>

                    <img src="d19.jpg" alt="" class="img-fluid img-thumbnail"> 
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="grid">
            ...
            <div class="row">
                <div class="col-md-3">
                    <br>
                    <img src="d0.jpg" alt="" class="img-fluid img-thumbnail"> 
                </div>

                <div class="col-md-4">
                    <br>

                    <img src="d1.jpg" alt="" class="img-fluid img-thumbnail"> 
                </div>

                <div class="col-md-4">
                    <br>

                    <img src="d14.jpg" alt="" class="img-fluid img-thumbnail"> 
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="grid">
            ...
            <div class="row">
                <div class="col-md-3">
                    <br>
                    <img src="d7.jpg" alt="" class="img-fluid img-thumbnail"> 
                </div>

                <div class="col-md-4">
                    <br>

                    <img src="d16.jpg" alt="" class="img-fluid img-thumbnail"> 
                </div>

                <div class="col-md-4">
                    <br>

                    <img src="d12.jpg" alt="" class="img-fluid img-thumbnail"> 
                </div>
            </div>
        </div>
